...
export default function CheckoutSuccessClient() {
        ...
        <main className="min-h-screen bg-gradient-to-br from-[var(--brand-blue-light)]/30 via-background to-background flex items-center justify-center px-4">
          <div className="max-w-2xl w-full text-center space-y-6">
            ...
            <Button
              asChild
              size="lg"
              className="bg-[var(--brand-coral)] hover:bg-[var(--brand-coral)]/90 text-white"
            >
  ...
  const displayStatus =
    status === "cash_on_delivery" || status === "cod" ? "Processing" : "Processing";
        ...
        <div className="max-w-2xl w-full text-center space-y-12 relative z-10">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-foreground/70 leading-relaxed">
              Thank you for your purchase! Your order has been successfully placed and we&apos;re
              getting it ready to cuddle its way to you.
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-lg border border-[var(--brand-blue-light)]/20 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-2xl font-bold text-[var(--brand-blue-dark)]">
                  {orderNumber || `#${orderId?.substring(0, 12).toUpperCase()}`}
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-2xl font-bold text-[var(--brand-blue-dark)]">{formattedDate}</p>
              </div>
            ...
            <div className="border-t border-[var(--brand-blue-light)]/20 pt-6">
              <p className="text-foreground/70 text-sm leading-relaxed">
                We&apos;re packing your Kuddles with extra love! You&apos;ll receive a shipping
                confirmation email with tracking information within 24 hours.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <Button
              asChild
              size="lg"
              className="bg-[var(--brand-coral)] hover:bg-[var(--brand-coral)]/90 text-white rounded-full font-semibold"
            >
              <Link href="/shop">Continue Shopping</Link>
            </Button>
          </div>
